const pic1 = 'https://imazh.studio/img/Motion-Graphic/1-karafarini.jpg'
const pic2 = 'https://imazh.studio/img/Motion-Graphic/2-characteric.jpg'
const pic3 = 'https://imazh.studio/img/Motion-Graphic/3-eid.jpg'
const pic4 = 'https://imazh.studio/img/Motion-Graphic/4-serat1.jpg'
...
const video4 = 'https://www.aparat.com/video/video/embed/videohash/bWGCp/vt/frame'
...
export const MotionGraphicContent = [
    {
        src: pic1,
        iframe: video1,
        title: 'موشن تیزر مدارس کار آفرینی',
        text: 'به سفارش کانون نخبگان وآینده سازان',
        enTitle: 'Motion teaser of entrepreneurship schools',
        enText: 'By order of the Elite and Future Makers Association'
    },
    {
        src: pic2,
        iframe: video2,
        title: 'موشن گرافیک کاراکتریک',
        text: 'به سفارش شرکت گاز شهر بوشهر',
        enTitle: 'Characteristic motion graphics',
        enText: 'By order of Bushehr Gas Company'
    },
    {
        src: pic3,
        iframe: video3,
        title: 'موشن اعیاد شعبانیه',
        text: 'به سفارش کانون نخبگان وآینده سازان',
        enTitle: "Motion of Sha'ban holidays",
        enText: 'By order of the Elite and Future Makers Association'
    },
    {
        src: pic4,
    ...
    },
    {
        src: pic5,
        iframe: video5,
        title: 'موشن تیزر رویداد مردمی تب آپ',
        text: 'به سفارش کانون نخبگان وآینده سازان',
        enTitle: 'Motion teaser of the popular event Teb Up',
        enText: 'By order of the Elite and Future Makers Association'
    },
    {
        src: pic6,
    ...
    },
    {
        src: pic7,
        iframe: video7,
        title: 'موشن تیزر مسابقات جنگ بدون جغرافیا',
